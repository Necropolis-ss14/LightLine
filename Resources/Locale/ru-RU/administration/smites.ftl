...
admin-smite-nyanify-name2 = Кошачьи уши - белые
admin-smite-pacify-name = Умиротворить
admin-smite-nyanify2-description = Принудительно добавляет белые кошачьи уши, спасения нет.
admin-smite-terminate-description = Создаёт призрачную роль Терминатора с единственной целью — убить его.
admin-smite-pacify-description = Делает цель пацифистом.
admin-trick-electrify-description = Электрифицировать целевой шлюз.
admin-trick-unelectrify-description = Снять электрификацию с целевого шлюза.
admin-trick-toggle-overlays-description = Переключить все оверлеи на цели.
admin-smite-scramble-name = Перемешать ДНК
admin-smite-scramble-description = Перемешивает ДНК, рандомизируя внешность персонажа.
