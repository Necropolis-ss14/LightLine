...
signal-port-description-nuclear-reactor-data-sender = Передача информации о ядерном реакторе на монитор.

signal-port-name-gas-turbine-data-sender = Газовая турбина
signal-port-description-gas-turbine-data-sender = Передача информации о газовой турбине на монитор.
