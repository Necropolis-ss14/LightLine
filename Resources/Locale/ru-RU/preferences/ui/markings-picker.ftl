...
markings-used = Используемые маркировки
markings-unused = Неиспользуемые маркировки
markings-add = Добавить маркировку
markings-remove = Убрать маркировку
markings-rank-up = Выше
markings-rank-down = Ниже
marking-points-remaining = Осталось маркировок: {$points}
