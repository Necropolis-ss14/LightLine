...
# Cargo
id-card-access-level-salvagelead = Лидер утилизаторов
id-card-access-level-mining = Добыча
...
# Cyborgs
id-card-access-level-cargo-cyborg = Грузовой киборг
id-card-access-level-engineering-cyborg = Инженерный киборг
id-card-access-level-research-cyborg = Научный киборг
id-card-access-level-security-cyborg = Охранный киборг
id-card-access-level-service-cyborg = Сервисный киборг
id-card-access-level-medical-cyborg = Медицинский киборг

# Misc
id-card-access-level-freelance = Внештатный
...
id-card-access-level-solgov = СолПравительство
