...
central-command-revolution-announcement = По данным наших сканеров дальнего радиуса действия, мы полагаем, что станция перешла под контроль враждебных революционных сил. Все главы отделов confirmed погибли, пропали без вести или покинули станцию. Всем оставшимся членам экипажа приказано ждать дальнейших инструкций.
soviet-commissariat-revolution-announcement = Дальняя связь онлайн. Родина приветствует вас, товарищи, но битва ещё не окончена. Ваша корпорация проверит, сможет ли она в последний раз вернуть вашу станцию, но не волнуйтесь! СССП скоро прибудет. Слава ССП!
centcomm-revs-gammarift = По данным сканеров дальнего радиуса действия, мы обнаружили враждебную революционную активность на борту. Военное положение вступило в силу. Слава НаноТрейзен.
centcomm-revs-alldead = Сканеры дальнего радиуса действия сообщают, что все агенты СКБ ССП на борту теперь окончательно мертвы.
central-command-sender = Центральное командование
soviet-commissariat-sender = Советский народный комиссариат
rev-deconverted-rule = Напоминание: согласно правилу 3 правил сервера, [bold][color=#a4885c]Деконвертированные революционеры забывают, что происходило, пока они были промыты.[/color][/bold]
rev-deconverted-ruletext = Ваш персонаж может узнать о произошедшем в ходе дальнейшего расследования и отыгрыша, но не должен помнить, что был революционером, ни действий, совершённых ради революции.
