...
book-text-agrichemkit-manual = Спасибо, что выбрали безопасный для любого возраста набор химика от Nanotrasen "АгроХимия это весело" — лучшую обучающую игру 2468 года! Приготовьтесь узнать всё о крупнейших инновациях сельского хозяйства с поры, как люди закапывали рыбу вместе с семенами кукурузы.
      ...
      Смешайте 3 доли водорода с 1 долей азота в микроволновке на 30 секунд, чтобы получить аммиак. Это полезное и питательное средство для ваших культур, находящихся не в лучшем состоянии.
...
book-text-moproach = Поздравляем с получением личного набора мопроуча! Идеальное решение на случай кровавой бани на вашей станции.
    Содержимое:
    - два куба мопроуча
    - две фиолетовые крышки
    - это руководство
    Инструкция:
    - возьмите куб
    - полейте водой
    - наденьте крышку на мотылька
    Готово! У вас свой личный мотылёк, только не забывайте его кормить!
