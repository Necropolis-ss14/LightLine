...
conntrack-resolve-failed-retry = Серверу не удалось проверить ваше подключение прямо сейчас, и у него нет предыдущего записанного адреса вашей учётной записи. Пожалуйста, переподключитесь чуть позже.
