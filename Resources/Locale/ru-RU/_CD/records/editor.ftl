...
humanoid-profile-editor-cd-records-contact-name = Имя(а) экстренного контакта:
...
humanoid-profile-editor-cd-records-drug-allergies = Лекарственные аллергии:
humanoid-profile-editor-cd-records-postmortem = Посмертные указания:

# Admin
humanoid-profile-editor-cd-records-admin = Администратор
...
cd-records-entry-edit-popup-description-too-long = Описание слишком длинное! ({$current}/{$max} символов)
