...
nano-chat-max-recipients = Достигнуто максимальное число чатов
...
nano-chat-list-number = Опубликовать номер
# Create chat popup
...
# LogProbe additions
log-probe-scan-nanochat = Отсканированы логи NanoChat {$card}
