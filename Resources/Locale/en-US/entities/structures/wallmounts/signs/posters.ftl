...
ent-PosterContrabandDonutCorp = Пончик корп.
    .desc = Этот плакат является несанкционированной рекламой Пончик корп.
...
ent-PosterContrabandRobustSoftdrinks = Робаст напитки
    .desc = Робаст анти-сушняк: Робастнее чем удар ящиком инструментов по голове!
ent-PosterContrabandShamblersJuice = Сок Шемблер
    .desc = ~Взболтайте мне немного этого сока Шемблер!~
...
ent-PosterContrabandBanzai = Восходящее солнце
    .desc = Плакат с лучами восходящего солнца и японскими иероглифами '天皇陛下万歳'. Внешне выглядящим довольно старым.
ent-PosterContrabandHotVulpsIsland = Остров горячих вульп
    .desc = Высокое солнце, горячие пески и бескрайние просторы моря ждут тебя на тропическом острове. Просто подпишите наши услуги отпускной поездки прямо сейчас на that.beautifullife.nt! Вы не пожалеете!
ent-PosterContrabandPinkEvil = Я не зло!
    .desc = Изображение плачущего розового вульпканина, на которых обычно клеветают, что они само порождение дьявола.
...
ent-PosterLegitKeepWater = Береги воду
    .desc = Плакат призываюший сохранять ограниченное количество воды.
